...
# If the rotating period is 120 seconds...
# Adsorption may take 90 seconds
y_res = c1.run_mamoen(90, 5, CPUtime_print = True)
c1.Graph(10, 3,file_name = 'TSA02_C3.png', dpi = 300)
c1.Graph_P(10, file_name = 'TSA02_P.png', dpi = 300)
plt.show()
