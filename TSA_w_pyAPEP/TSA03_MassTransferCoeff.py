...
# If the rotating period is 1200 seconds...
# Adsorption may take 900 seconds
y_res = c1.run_mamoen(900, 5, CPUtime_print = True)
c1.Graph(100, 3, file_name = 'TSA02_C3.png', dpi = 300)
c1.Graph_P(100, file_name = 'TSA02_P.png', dpi = 300)
plt.show()
